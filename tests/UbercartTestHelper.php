...
class UbercartTestHelper
{
    ...
    /**
     * UbercartTestHelper constructor.
     *
     * @param \Ubercart\UbercartTest|\Ubercart\UbercartFullTest $ubercart_test
     */
    public function __construct($ubercart_test) {
        $this->main_test    = $ubercart_test;
        $this->wd           = $ubercart_test->wd;
    ...
    public function get_slug($str, $delimiter = '-') {
        ...
        $slug = strtolower(trim(preg_replace('/[\s-]+/', $delimiter, preg_replace('/[^A-Za-z0-9-]+/', $delimiter,
